package io.github.futurewl.smarthome.demo.shadow;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import io.github.futurewl.smarthome.demo.iothub.ALiyunIotX509TrustManager;
import io.github.futurewl.smarthome.util.AliyunWebUtils;
import io.github.futurewl.smarthome.util.LogUtil;
import io.github.futurewl.smarthome.util.SignUtil;
...
public class SimpleClient4Shadow {
     ...
     * 设备key和secret信息
     */
    private static String deviceName = "bst-1";
    private static String productKey = "Fo45n88regY";
    private static String deviceSecret = "GxSwKxOm7gZ5mzhf2TMdBls7GeDUin1z";
