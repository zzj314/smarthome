 ...
 */
package io.github.futurewl.smarthome.demo.iothub;

import io.github.futurewl.smarthome.DeviceApplication;
...
public class ALiyunIotX509TrustManager extends X509ExtendedTrustManager {
    ...
    public ALiyunIotX509TrustManager() throws Exception {
        //CA根证书，可以从官网下载
        InputStream in = DeviceApplication.class.getResourceAsStream("/root.crt");
